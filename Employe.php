...
<ul>
    ...
    <ul>
    <li> <a href = "Employe.php"> Employe ALSH </a>
     
    </li>
  </ul>

    <ul>
    <li> <a href = "Planning.php"> Planning </a>
...
<img src="/Projet/Image/Fond/employe.jpeg" style="border-radius: 10px; height: 370px; width: 960px; margin-top: 60px;"  />
  </div>


<div class="card2">
  <?php include 'Employe1.php'; ?>
</div>
