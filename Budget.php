...
<label> Centre </label>
<select name="Centre">
	<option value="CT"> ALSH Croix Tienac </option>
	<option value="Murget"> ALSH Murget </option>
	<option value="Godeau"> ALSH Godeau </option>
</select>
...
<img src="/Projet/Image/Fond/budget1.jpg" style="border-radius: 10px; height: 640px; width: 960px; margin-top: 60px;"  />
